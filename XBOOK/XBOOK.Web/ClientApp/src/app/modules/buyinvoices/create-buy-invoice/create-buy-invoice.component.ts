...
import { SupplierSearchModel } from '@modules/_shared/models/supplier/supplier-search.model';
import { BuyInvoiceService } from '@modules/_shared/services/buy-invoice.service';
import { BuyInvoiceView } from '@modules/_shared/models/invoice/buy-invoice-view.model';
  ...
  save() {
    ...
    if (!this.invoiceForm.valid && this.invoiceId === 0) {
      ...
      const request = {
        ...
        status: '',
        supplierID: this.invoiceForm.value.contactName.supplierID !== undefined ? this.invoiceForm.value.contactName.supplierID : 0,
        ...
        address: this.invoiceForm.value.address === undefined ? this.invoiceForm.value.contactName.address : this.invoiceForm.value.address,
        taxCode: this.invoiceForm.value.taxCode === undefined ? this.invoiceForm.value.contactName.taxCode : this.invoiceForm.value.taxCode,
        tag: '',
        contactName:
        ...
        email: this.invoiceForm.value.email === undefined ? this.invoiceForm.value.contactName.email : this.invoiceForm.value.email,
      };
      const requestInvDt = [];
