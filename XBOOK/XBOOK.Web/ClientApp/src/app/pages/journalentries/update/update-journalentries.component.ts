...
@Component({
  ...
  selector: 'xb-update-journalentries',
  templateUrl: './update-journalentries.component.html',
  styleUrls: ['./update-journalentries.component.scss'],
})
export class EditJournalComponent extends AppComponentBase implements OnInit {
  @Input() title;
  @Input() id: number;
  ...
  onBlurCheckvalue(accNumber: any, crspAccNumber: any) {
  ...
  save() {
    ...
    if (this.invoiceId > 0) {
      const request = {
        ...
        objectName: this.invoiceForm.value.objectName.objectName,
