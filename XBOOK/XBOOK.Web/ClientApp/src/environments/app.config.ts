export const API_URI = {
  ...
  getCashBalance: 'api/MoneyFund/GetALLMoneyFundServiceDapper',
  getDataCashBalanceReport: 'api/MoneyFund/GetDataMoneyFundReportServiceDapper',
  CashBalanceSaveDataPrint: 'api/MoneyFund/SaveFileJson',
